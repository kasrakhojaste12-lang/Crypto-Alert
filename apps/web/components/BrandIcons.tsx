// Official Telegram & Discord brand marks as inline SVG — crisp at any size,
// correct brand colors, no remote-image dependency.
...
export function TelegramIcon({ className = 'h-6 w-6' }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" className={className} aria-hidden="true">
      ...
      <path
        fill="#fff"
        d="M5.491 11.74l11.57-4.461c.537-.194 1.006.131.832.943l-1.97 9.281c-.146.658-.537.818-1.084.508l-3-2.211-1.447 1.394c-.16.16-.295.295-.605.295l.213-3.053 5.56-5.022c.242-.213-.054-.333-.373-.121L7.61 13.191l-2.966-.924c-.643-.203-.657-.643.146-.953z"
      />
    </svg>
  )
}
...
export function DiscordIcon({ className = 'h-6 w-6' }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" className={className} aria-hidden="true">
      <path
        fill="#5865F2"
